...
\caption{\tcb{PICTURE TO BE REPLACED BY UPDATED LAYOUT. Will probably choose something with more details on the infrastructure  (tunnels, shafts etc) and less details on what is inside vacuum system} Simplified drawing of the low and high frequency core interferometers of a single ET-detector. Injection and detection optics as well as filter cavities have been omitted for clarity. Please not that the complete ET observatory consists of three such detectors.%
}
