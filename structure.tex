...
\setcounter{secnumdepth}{4} % also number paragraphs
\setcounter{tocdepth}{5} % show all sectionings in toc
...
{\addvspace{1pt}\sffamily\bfseries\small} % Spacing and font options for subsections
...
{\contentslabel[\thecontentslabel]{2cm}} % Subsubsection number
{}
{\sffamily\;\titlerule*[.5pc]{.}\;\thecontentspage} % Page number
[]
...
{\contentslabel[\thecontentslabel]{2.25cm}} % paragraph number
{}
{\sffamily\;\titlerule*[.5pc]{.}\;\thecontentspage} % Page number
[]
